  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-1.5">
        ...
        <p className="text-center text-sm text-muted-foreground">Supports all audio formats, max size 20MB</p>
      </div>
          ...
          <CommandList>
            ...
            <CommandGroup>
              {LANGUAGE_OPTIONS.map((lang) => (
                ...
                >
                  {lang.label}
                  <Check className={cn("ml-auto size-4", value === lang.value ? "opacity-100" : "opacity-0")} />
                </CommandItem>
              ))}
            </CommandGroup>
          </CommandList>
      ...
      <div className={cn(scrollable ? "no-scrollbar flex flex-col gap-6 overflow-y-auto px-4" : "flex flex-col gap-6")}>
        ...
        <form.Field name="language">
          {(field) => {
            ...
            return (
              <Field data-invalid={isInvalid}>
                <LanguageCombobox value={field.state.value} onChange={field.handleChange} isInvalid={isInvalid} />
                {isInvalid && <FieldError errors={field.state.meta.errors} />}
              </Field>
            )
          }}
